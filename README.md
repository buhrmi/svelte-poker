...
A poker frontend to try out Svelte/Sapper. Currently it only works with servers running the (proprietary) Buka protocol, but support for different servers/engines might be added in the future.
